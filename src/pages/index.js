...
const IndexPage = () => {
    ...
    return(
        ...
        <p style={pStyle}>Want to hire me and get dogs and jokes?: <a target="_blank" rel="noopener noreferrer" style={linkStyle} href="http://linkedin.com/in/nicholasfeitel">LinkedIn</a></p>
